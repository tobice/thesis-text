...
\todo[color=green!40]{Jirka Helmich: kde jste ho vzal, jak jste ho vyrobil, citace ETL... Tobiáš Potoček: Toto zmiňuji o něco dále. Jakým způsobem jsou data sety převedeny do RDF a do RGML vocabulary. Musím to nějakým způsobem zmínit už zde?}
...
\todo[color=green!40]{Visualizer ještě projde nějakým tím lehkým faceliftingem, tak teprve pak doplním obrázky do kapitoly.}
