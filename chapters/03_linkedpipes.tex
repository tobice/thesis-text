...
\todo[color=green!40]{I'm not sure about the correct naming. The visualizer actually visualizes pipeline evaluation results but what is passed through the parameter is the pipeline evaluation id (and the latest evaluation result is selected). That is however an implementation detail...}
