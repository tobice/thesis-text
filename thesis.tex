...
\def\Dedication{%
I would like to thank my supervisor RNDr. Jiří Helmich for his patience and guidance that helped me with finishing this work.
}
...
\include{chapters/04_system_proposal}
\include{chapters/05_implementation}
\include{chapters/06_visualizers}
\include{chapters/07_theoretical_attachment}
...
\appendix
\include{chapters/attachment_01_devstack}
\include{chapters/attachment_02_online_sources}
\include{chapters/attachment_03_cd_contents}
